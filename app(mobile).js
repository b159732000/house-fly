...
element.addEventListener('ontouchstart', console.log("touchstart"), false);
element.addEventListener('ontouchstart', onDocumentMouseDown, false);
element.addEventListener('ontouchmove', a, false);
// element.addEventListener('ontouchmove', mouseMoveOnGroundPlayBack, false);
// element.addEventListener('ontouchmove', changeMouseCurrentXY, false);
// element.addEventListener('click', scanMouseProjectToObject, false);
// element.addEventListener('mousewheel', onDocumentMouseWheel, false);
// element.addEventListener('DOMMouseScroll', onDocumentMouseWheel, false);//宣告變數
